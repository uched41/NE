...
void LIS3DH_Init(void){
  APP_ERROR_CHECK(nrf_drv_mpu_init());
  ...
  LIS3DH_SetIntConfiguration(LIS3DH_INT1_OR | LIS3DH_INT1_ZHIE_DISABLE | LIS3DH_INT1_ZLIE_DISABLE |
                              ...
                              LIS3DH_INT1_XHIE_ENABLE  | LIS3DH_INT1_XLIE_DISABLE );

  LIS3DH_SetInt1Threshold(0x10);

  LIS3DH_SetInt1Duration(0x01);
...
u8_t LIS3DH_ReadReg(u8_t Reg, u8_t* Data) { 
  nrf_drv_mpu_read_registers(Reg, Data, 1);
  return 1;
}


u8_t LIS3DH_WriteReg(u8_t WriteAddr, u8_t Data) {
  nrf_drv_mpu_write_single_register(WriteAddr, Data); 
  return 1;
}
...
uint8_t SetLIS3DHActivityDetection(uint8_t Th, LIS3DH_Int1Mode_t Mode, uint8_t OnOff)
{
    ...
    if(OnOff){
        response = LIS3DH_SetIntConfiguration(LIS3DH_INT1_ZHIE_ENABLE | LIS3DH_INT1_ZLIE_ENABLE |
                     LIS3DH_INT1_YHIE_ENABLE | LIS3DH_INT1_YLIE_ENABLE | LIS3DH_INT1_XHIE_ENABLE | LIS3DH_INT1_XLIE_ENABLE ); 
    }
    else{
        response = LIS3DH_SetIntConfiguration(LIS3DH_INT1_ZHIE_DISABLE | LIS3DH_INT1_ZLIE_DISABLE |
                     LIS3DH_INT1_YHIE_DISABLE | LIS3DH_INT1_YLIE_DISABLE | LIS3DH_INT1_XHIE_DISABLE | LIS3DH_INT1_XLIE_DISABLE ); 
    }
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
result_t LIS3DH_SetHPFMode(LIS3DH_HPFMode_t hpm) {
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
result_t LIS3DH_SetClickTHS(u8_t ths) {
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
result_t LIS3DH_SetClickLIMIT(u8_t t_limit) {
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
result_t LIS3DH_SetClickLATENCY(u8_t t_latency) {
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
result_t LIS3DH_SetClickWINDOW(u8_t t_window) {
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
result_t LIS3DH_GetClickResponse(u8_t* res) {
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
result_t LIS3DH_SetIntMode(LIS3DH_Int1Mode_t int_mode) {
  u8_t value;
